...
class TestStreamingChat:
    ...
    def mock_metadata(self):
        ...
        return {
            ...
            "documents": [
                {"filename": "test_doc.pdf", "company": "Test Company"}
            ]
        }
    
    @pytest.mark.asyncio
    async def test_process_streaming_chat_creates_tracker(self, mock_streaming_request, mock_s3_client, mock_metadata):
    ...
    @pytest.mark.asyncio
    async def test_process_streaming_chat_starts_background_task(self, mock_streaming_request, mock_s3_client, mock_metadata):
    ...
    @pytest.mark.asyncio
    async def test_process_chat_async_with_valid_metadata(self, mock_streaming_request, mock_s3_client, mock_metadata):
    ...
    @pytest.mark.asyncio
    async def test_process_chat_async_without_metadata(self, mock_streaming_request, mock_s3_client):
    ...
    @pytest.mark.asyncio
    async def test_process_chat_async_fast_mode(self, mock_streaming_request, mock_s3_client, mock_metadata):
...
class TestStreamingFinancialChat:
    ...
    @pytest.mark.asyncio
    async def test_process_streaming_financial_chat_creates_tracker(self, mock_streaming_request, mock_financial_manager):
    ...
    @pytest.mark.asyncio
    async def test_process_streaming_financial_chat_starts_background_task(self, mock_streaming_request, mock_financial_manager):
...
class TestStreamingIntegration:
    ...
    async def test_full_streaming_flow(self, mock_streaming_request, mock_s3_client, mock_metadata):
        ...
        with patch('app.streaming_chat._process_traditional_chat', side_effect=mock_traditional_chat):
